			...
			@foreach($customers as $customer)
				<div class="dropdown">
					<button class="btn btn-sm btn-outline-info dropdown-toggle customer-info-bar" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						&nbsp&nbsp{{ $customer['customer_id'] }} <br>
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						<div class="row">
							<div class="col-md-12">
								<a class='dropdown-item' href="/customer/{{$customer['customer_id']}}">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<a class='dropdown-item' href="/customer/{{$customer['customer_id']}}/edit">
									{{-- <button>Edit</button> --}}
									Edit
								</a>
							</div>
