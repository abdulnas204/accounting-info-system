...
<div class="tx"><div class="tx-row"><span class="cell number-cell">{{-- {{$i}} --}}</span><input type="text" class="cell date-cell" value="{{ $account['date'] }}" disabled><input type="text" class="cell transaction-cell" value="{{ $account['account_name'] }}" disabled><input type="text" class="cell debit-cell" value="@if($account['transaction_type']==='Debit'){{$account['transaction_amount']}}@endif" disabled><input type="text" class="cell credit-cell" value="@if($account['transaction_type']==='Credit'){{$account['transaction_amount']}}@endif" disabled><input type="text" class="cell desc-cell" value="{{$account['transaction']}}" disabled></div></div>@endforeach{{-- //////

/////// --}}<hr><hr><hr><div class="tx"><div class="tx-row"><span class="cell number-cell"></span><input type="text" class="cell date-cell"><input type="text" class="cell transaction-cell"><input type="text" class="cell debit-cell"><input type="text" class="cell credit-cell"><input type="text" class="cell desc-cell"></div><div class="tx-row"><span class="cell number-cell"></span><input type="text" class="cell date-cell"><input type="text" class="cell transaction-cell"><input type="text" class="cell debit-cell"><input type="text" class="cell credit-cell"><input type="text" class="cell desc-cell"></div></div></div>{{-- ledger-body --}}
